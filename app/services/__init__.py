...
Services added per module:
    ...
    M6: query_service.py           -- RAG query pipeline orchestrator (RETRIEVE only)
    M7: routed_query_service.py    -- Router Agent + QueryService coordinator
                                      (DIRECT or RETRIEVE depending on routing decision)
"""
